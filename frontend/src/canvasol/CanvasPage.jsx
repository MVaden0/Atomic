import { useEffect, useRef, useReducer, useLayoutEffect, useCallback, useContext, createContext } from 'react'
        ...
        <CanvasContextProvider>
            ...
            >
                ...
                <Surface backgroundCanvasRef={backgroundCanvasRef} state={state} showLines={false}>
                    <Ellipse cx={0} cy={0} rx={100} ry={100} fill={'#123ead'} canvasState={state}/>
                    <Path points={test}/>
                </Surface>
            </div>
        </CanvasContextProvider>   
